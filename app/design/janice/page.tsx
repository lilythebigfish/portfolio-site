...
const ProjectPage = () => {
  const [project] = useState<Project>({
    ...
    description:
      "Proposed and designed the full UX for a chatbot app that advises users on style options and facilitates their fashion shopping.",
    design: true,
      ...
      <article className="flex-grow mx-60 pt-36">
        <div className="grid grid-cols-3 gap-32">
          <div className="col-start-1 col-span-1">
            ...
            <Body
              content="Our client, Social Future, is a Chinese AI-focused app development company. 
        ...
        <Body
          content='We researched the current usages for AI chatbots, and categorized the market opportunities for new chatbots into: 
